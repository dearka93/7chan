...
class CommentController implements \Anax\DI\IInjectionAware
{
    ...
    public function idAction($id = null)
    {
        ...
        $sql = "SELECT * FROM projekt_comments4comment WHERE questionId = ?";  
        $params = array($id);
        $resKommentar = $this->db->executeFetchAll($sql, $params);
        
        $sql = "SELECT * FROM projekt_answers WHERE questionId = ?";  
        $params = array($id);
        $resAnswer = $this->db->executeFetchAll($sql, $params);    
        
        $sql = "SELECT * FROM projekt_comments4answer WHERE questionId = ?";  
        $params = array($id);
    ...
    if (isset($_SESSION['user'])){
        ...
        if ($status === true) {
            ...
            $sql = "SELECT points FROM projekt_user WHERE id = ?";
            $params = array($userId);
            $point = $this->db->executeFetchAll($sql, $params);
            $point = $point[0]->points;
            $point++;
            
            $sql = "UPDATE projekt_user SET points = ? WHERE id = ?";
...
//rensar alla taggar för nuvarande kommentar, för att kunna updatera och lägga in nya taggar.                    
            ...
            foreach($oldTags as $oldTag){
                ...
                foreach($allaTaggar as $enTag) {
                    ...
                    if ($antal == '0'){
                    $updateSql = "DELETE FROM projekt_tags WHERE tag = ?";
    ...
    {   
        ...
        $sql = "SELECT * FROM projekt_comment Where tag LIKE '%".$tag."%';";
    ...
    if (isset($_SESSION['user'])){
                    ...
                    $now = date('Y-m-d H:i:s'); 
                    $sql = "INSERT INTO projekt_comments4comment (questionId, content, userId, userAcr, userMail, timestamp) VALUES(?, ?, ?, ?, ?, ?)";
    ...
    if (isset($_SESSION['user'])){
                    ...
                    $now = date('Y-m-d H:i:s'); 
                    $sql = "INSERT INTO projekt_answers (questionId, content, userId, userAcr, userMail, timestamp, choose) VALUES(?, ?, ?, ?, ?, ?, ?)";
    ...
    public function commentAnswerAction($id = null)
    {
        ...
        $sql = "SELECT * FROM projekt_answers WHERE id = ?";
        $params = array($id);
        $res = $this->db->executeFetchAll($sql, $params);
    ...
    if (isset($_SESSION['user'])){
                    $content = $this->textFilter->doFilter($form->Value('content'), 'shortcode, markdown');        
                    $now = date('Y-m-d H:i:s'); 
                    $sql = "INSERT INTO projekt_comments4answer (id, questionId, content, userId, userAcr, userMail, timestamp) VALUES(?, ?, ?, ?, ?, ?, ?)";
    ...
    public function acceptAction($id = null)
    {
        ...
        $sql = "SELECT * FROM projekt_comment WHERE id = ? ";
        $params = array($ques);
        $res = $this->db->executeFetchAll($sql, $params);
        $anv = $res[0]->userAcr;        
        ...
        $sql = "UPDATE projekt_answers SET choose = ? WHERE id = ?";
    ...
    public function voteUpCommentAction($id = null){
        if (isset($_SESSION['user'])){
        $sql = "SELECT points FROM projekt_comments4comment WHERE id = ?";
        $params = array($id);
        $point = $this->db->executeFetchAll($sql, $params);
        $point = $point[0]->points;
        $point++;
        
        $sql = "UPDATE projekt_comments4comment SET points = ? WHERE id = ?";
        $params = array($point, $id);
        $res = $this->db->execute($sql, $params);
        
        $sql = "SELECT * FROM projekt_comments4comment WHERE id = ?";
        $params = array($id);
        $res = $this->db->executeFetchAll($sql, $params);
        $questionId = $res[0]->questionId;
    ...
    public function voteUpAnswerAction($id = null){
        if (isset($_SESSION['user'])){
        $sql = "SELECT points FROM projekt_answers WHERE id = ?";
        $params = array($id);
        $point = $this->db->executeFetchAll($sql, $params);
        $point = $point[0]->points;
        $point++;
        
        $sql = "UPDATE projekt_answers SET points = ? WHERE id = ?";
        $params = array($point, $id);
        $res = $this->db->execute($sql, $params);
    ...
    public function voteUpCommentAnsAction($id = null){
        if (isset($_SESSION['user'])){
        $sql = "SELECT points FROM projekt_comments4answer WHERE commentId = ?";
        $params = array($id);
        $point = $this->db->executeFetchAll($sql, $params);
        $point = $point[0]->points;
        $point++;
        
        $sql = "UPDATE projekt_comments4answer SET points = ? WHERE commentId = ?";
        $params = array($point, $id);
        $res = $this->db->execute($sql, $params);
        
        $sql = "SELECT * FROM projekt_comments4answer WHERE commentId = ?";
        $params = array($id);
        $res = $this->db->executeFetchAll($sql, $params);
        $questionId = $res[0]->questionId;
    ...
    public function voteUpAction($id = null){
        if (isset($_SESSION['user'])){
        $sql = "SELECT points FROM projekt_comment WHERE id = ?";
        $params = array($id);
        $point = $this->db->executeFetchAll($sql, $params);
        $point = $point[0]->points;
        $point++;
        
        $sql = "UPDATE projekt_comment SET points = ? WHERE id = ?";
        $params = array($point, $id);
        $res = $this->db->execute($sql, $params);
